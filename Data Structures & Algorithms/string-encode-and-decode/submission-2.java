class Solution {
    ...
    public List<String> decode(String str) {
        ...
        for(index = 0; str.charAt(index) != '#'; index++) {
            ...
            // we parse the current value of the StringBUilder and add it into the string size list when we encounter a delimiter ",".
            // then reinitialize num with a new StringBuilder object to clear it
            if(c == ',') {
