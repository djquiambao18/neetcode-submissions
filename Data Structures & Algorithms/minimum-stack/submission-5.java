...
class MinStack {
    ...
    public void pop() {
        ...
        // no need to check if minStack is empty and mainStack is empty then push that value into minstack since
        // at the very first value, both main and min stacks are non-empty and only at the last pop
        // will both be empty. so, both stacks are empty and non-empty at the same time.
    }
